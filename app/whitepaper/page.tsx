        ...
        <div className="container mx-auto px-4 py-8">
          <main>
            <section className="text-center py-16">
              <h1 className="text-5xl font-bold mb-4">White paper</h1>
              ...
              <img
                ...
                width="600"
              />
              <p className="text-sm mt-4">A network property owned by the community and for the community</p>
            </section>
            ...
            <section className="py-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-gray-100 p-4">
                  <h3 className="font-bold mb-2">KaKacoin World</h3>
                  <p className="text-sm mb-4">
                ...
                <div className="bg-gray-100 p-4">
                  <h3 className="font-bold mb-2">KaKacoin GameFi</h3>
                  <p className="text-sm mb-4">
            ...
            <section className="py-8">
              ...
              <h3 className="font-bold mb-2">Distribution ratios for KKC (total supply: 1 billion tokens):</h3>
              <ul className="list-disc pl-6 mb-4">
                <li>Foundation: 30.0%</li>
                <li>Market Circulation: 45.0%</li>
                <li>Community Marketing and Promotion: 15.0%</li>
